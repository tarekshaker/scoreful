        ...
        <div class="row">
          ...
          <div class="col-xl-8 mb-4 mb-xl-0">
            ...
            <div class="alert alert-success alert-dismissible mb-4" role="alert">
              <div class="d-flex gap-4">
                <div class="flex-shrink-0">
                  <span class="alert-icon rounded m-0">
              ...
              <button type="button" class="btn-close btn-pinned mt-3" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="text-body-secondary mb-2 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-4">Google</a> <span class="badge bg-label-success rounded-pill mt-2 mt-sm-0">In Stock</span></div>
                        <div class="read-only-ratings raty mb-2 px-0" data-rateyo-read-only="true" data-score="4" data-number="5"></div>
                        <input type="number" class="form-control form-control-sm w-px-100" value="1" min="1" max="5" />
                      </div>
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <button type="button" class="btn text-body-secondary p-0 shadow-none btn-pinned" aria-label="Close"><i class="icon-base ri ri-close-line icon-base ri icon-18px"></i></button>
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="text-body-secondary mb-2 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-4">Apple</a> <span class="badge bg-label-success rounded-pill mt-2 mt-sm-0">In Stock</span></div>
                        <div class="read-only-ratings raty mb-2 px-0" data-rateyo-read-only="true" data-score="4" data-number="5"></div>
                        <input type="number" class="form-control form-control-sm w-px-100" value="1" min="1" max="5" />
                      </div>
                      <div class="col-md-4">
            ...
            <div class="list-group">
              <a href="javascript:void(0)" class="list-group-item text-primary d-flex justify-content-between align-items-center">
          ...
          <div class="col-xl-4">
            <div class="border rounded p-5 mb-4">
              ...
              <dl class="row mb-0">
                ...
                <dd class="col-6 text-end"><s class="text-body-secondary me-1">$5.00</s> <span class="badge bg-label-success rounded-pill text-uppercase">Free</span></dd>
              </dl>
              <hr class="mx-n5 my-5" />
              <dl class="row mb-0">
      ...
      <div id="checkout-address" class="content">
        <div class="row">
          ...
          <div class="col-xl-8 mb-4 mb-xl-0">
                ...
                <div class="form-check custom-option custom-option-basic checked">
                  <label class="form-check-label custom-option-content" for="customRadioAddress1">
                    ...
                    <span class="custom-option-body">
                      <small class="d-xxl-block pe-xxl-12 me-xxl-12">4135 Parkway Street, Los Angeles, CA, 90017.<br />
            ...
            <!-- Choose Delivery -->
            <h6 class="fw-medium">Choose Delivery Speed</h6>
            <div class="row">
          ...
          <div class="col-xl-4">
            <div class="border rounded p-5 mb-4">
              ...
              <dl class="row mb-0">
                ...
                <dt class="col-6 fw-normal text-heading">Delivery Charges</dt>
                <dd class="col-6 text-end"><s class="text-body-secondary">$5.00</s> <span class="badge bg-label-success rounded-pill text-uppercase">Free</span></dd>
              </dl>
              <hr class="mx-n5 my-5" />
              <dl class="row mb-0">
                <dt class="col-6 text-heading">Total</dt>
          ...
          <div class="col-xl-8 mb-4 mb-xl-0">
            ...
            <div class="col-xxl-7 col-lg-8">
              <div class="nav-align-top">
                <ul class="nav nav-pills row-gap-2 flex-wrap mb-6" id="paymentTabs" role="tablist">
                ...
                <div class="tab-pane fade show active" id="pills-cc" role="tabpanel" aria-labelledby="pills-cc-tab">
                  <div class="row g-6">
                    ...
                    <div class="col-6 col-md-3">
                      <div class="input-group input-group-merge">
                        <div class="form-floating form-floating-outline">
                          <input type="text" id="paymentCardCvv" class="form-control cvv-code-mask pe-0" maxlength="3" placeholder="654" />
                          <label for="paymentCardCvv">CVV</label>
                        </div>
                        <span class="input-group-text cursor-pointer" id="paymentCardCvv2"><i class="icon-base ri ri-question-line" data-bs-toggle="tooltip" data-bs-placement="top" title="Card Verification Value"></i></span>
                      </div>
                    </div>
                    <div class="col-12">
        ...
        <div class="row mb-4">
          <div class="col-12 col-lg-8 mx-auto text-center mb-4">
            ...
            <p class="d-flex align-items-center justify-content-center">
              <span><i class="icon-base ri ri-time-line icon-20px text-heading me-1"></i></span>Time placed: 25/05/2020 13:35pm
            </p>
          </div>
          ...
          <div class="col-12">
            <ul class="list-group list-group-horizontal-md">
              <li class="list-group-item flex-fill p-5">
                <h6 class="d-flex align-items-center gap-2"><i class="icon-base ri ri-map-pin-line icon-20px"></i> Shipping</h6>
              ...
              <li class="list-group-item flex-fill p-5">
                <h6 class="d-flex align-items-center gap-2"><i class="icon-base ri ri-bank-card-line icon-20px"></i> Billing Address</h6>
                <address class="text-body">
                  John Doe <br />
                  4135 Parkway Street,<br />
                  Los Angeles, CA 90017,<br />
              ...
              <li class="list-group-item flex-fill p-5">
                <h6 class="d-flex align-items-center gap-2"><i class="icon-base ri ri-ship-2-line icon-20px"></i> Shipping Method</h6>
                  ...
                  <div class="flex-grow-1">
                    <div class="row d-flex align-items-center">
                      <div class="col-md-8 pt-2">
                        ...
                        <div class="text-body-secondary mb-2 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-1">Google</a></div>
                        <span class="badge bg-label-success rounded-pill mt-2 mt-sm-0">In Stock</span>
                      </div>
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <div class="my-2 my-lg-6"><span class="text-primary">$299/</span><span class="text-body-secondary">$359</span></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="flex-grow-1">
                    <div class="row d-flex align-items-center">
                      <div class="col-md-8 pt-2">
                        ...
                        <div class="text-body-secondary mb-1 d-flex flex-wrap"><span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-1">Apple</a></div>
                      </div>
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <div class="my-2 my-lg-6"><span class="text-primary">$899/</span><span class="text-body-secondary">$999</span></div>
                        </div>
                      </div>
                    </div>
                  </div>
