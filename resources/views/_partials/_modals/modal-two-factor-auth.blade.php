            ...
            <div class="form-check custom-option custom-option-basic">
              <label class="form-check-label custom-option-content" for="customRadioTemp1" data-bs-target="#twoFactorAuthOne" data-bs-toggle="modal">
                ...
                <span class="custom-option-header">
                  <span class="h6 mb-0 d-flex align-items-center"><i class="icon-base ri ri-settings-3-line icon-20px me-1"></i>Authenticator Apps</span>
                </span>
          ...
          <div class="col-12">
            <div class="form-check custom-option custom-option-basic">
              <label class="form-check-label custom-option-content" for="customRadioTemp2" data-bs-target="#twoFactorAuthTwo" data-bs-toggle="modal">
                ...
                <span class="custom-option-header">
                  <span class="h6 mb-0 d-flex align-items-center"><i class="icon-base ri ri-wechat-line icon-20px me-1"></i>SMS</span>
                </span>
                <span class="custom-option-body">
    ...
    <div class="modal-content">
      <div class="modal-body p-0">
        ...
        <div class="col-12 text-end">
          ...
          <button type="button" class="btn btn-primary" data-bs-dismiss="modal" aria-label="Close"><span class="align-middle">submit</span><i class="icon-base ri ri-check-line ms-1"></i></button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
    <div class="modal-content">
      <div class="modal-body p-0">
        ...
        <div class="col-12 text-end">
          <button type="button" class="btn btn-outline-secondary me-3" data-bs-toggle="modal" data-bs-target="#twoFactorAuth"><span class="align-middle">cancel</span></button>
          <button type="button" class="btn btn-success" data-bs-dismiss="modal" aria-label="Close"><span class="align-middle">submit</span><i class="icon-base ri ri-check-line ms-1"></i></button>
        </div>
      </div>
    </div>
  </div>
