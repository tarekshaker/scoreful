  ...
  <div class="modal-dialog modal-lg modal-simple modal-enable-otp modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="d-flex align-items-center flex-wrap mt-4">
        <i class="icon-base ri ri-group-line icon-20px text-heading me-2 align-self-start align-self-md-center"></i>
        <div class="d-flex justify-content-between flex-grow-1 align-items-center flex-wrap gap-3">
          ...
          <button class="btn btn-outline-primary"><i class="icon-base ri ri-link-m me-1_5"></i>Copy Project Link</button>
        </div>
      </div>
    </div>
  </div>
