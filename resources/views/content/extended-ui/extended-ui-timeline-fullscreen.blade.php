...
<div class="row overflow-hidden">
  <div class="col-12">
    <ul class="timeline timeline-center mt-12">
        ...
        <div class="timeline-event card p-0" data-aos="fade-left">
          ...
          <div class="card-body">
            <div class="d-flex flex-sm-row flex-column">
              <img src="{{ asset('assets/img/elements/4.png') }}" class="rounded me-4 mb-sm-0 mb-2" alt="doughnut" height="64" width="64" />
              <div>
      ...
      <li class="timeline-item timeline-item-left">
        ...
        <div class="timeline-event card p-0" data-aos="fade-right">
          ...
          <div class="card-footer d-flex justify-content-between">
            ...
            <div>
              <i class="icon-base ri ri-more-2-line cursor-pointer"></i>
            </div>
          </div>
      ...
      <li class="timeline-item border-0 pb-2">
        <span class="timeline-indicator timeline-indicator-info" data-aos="zoom-in" data-aos-delay="200">
