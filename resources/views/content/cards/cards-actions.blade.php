  ...
  <div class="card-header">
    ...
    <div class="card-action-element">
      <ul class="list-inline mb-0">
        ...
        <li class="list-inline-item">
          <a href="javascript:void(0);" class="card-expand"><i class="icon-base ri ri-fullscreen-fill icon-sm"></i></a>
        </li>
        <li class="list-inline-item">
          <a href="javascript:void(0);" class="card-close"><i class="icon-base ri ri-close-fill icon-sm"></i></a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="card card-action mb-6">
      ...
      <div class="collapse show">
        <div class="card-body">
          ...
          <p class="card-text">Click on <i class="icon-base ri ri-arrow-up-s-line icon-sm"></i> to see card collapse in
            action.</p>
        </div>
      </div>
    </div>
  ...
  <div class="col-md">
    <div class="card card-action mb-6">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Click on <i class="icon-base ri ri-refresh-line icon-sm scaleX-n1-rtl"></i> icon to see
  ...
  <div class="col-md">
    <div class="card card-action mb-6">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Click on <i class="icon-base ri ri-fullscreen-fill icon-sm"></i> icon to see expand card in
          action.</p>
      </div>
    </div>
  </div>
  <div class="col-md">
    <div class="card card-action mb-6">
      ...
      <div class="card-body">
        ...
        <br />
        <p class="card-text">Click on <i class="icon-base ri ri-close-fill icon-sm"></i> icon to see remove card in
          action.</p>
      </div>
    </div>
  </div>
      ...
      <div class="card-header header-elements">
        ...
        <div class="card-header-elements ms-auto">
          <button type="button" class="btn btn-xs btn-primary"><span
              class="icon-base ri ri-add-fill icon-sm me-1"></span>Button</button>
        </div>
      </div>
      <div class="card-body">
