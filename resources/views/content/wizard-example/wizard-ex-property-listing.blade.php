    ...
    <form id="wizard-property-listing-form" onSubmit="return false">
      ...
      <div id="personal-details" class="content">
        <div class="row g-6">
          ...
          <div class="col-12 d-flex justify-content-between">
            ...
            <button class="btn btn-primary btn-next"><span class="align-middle d-sm-inline-block d-none me-sm-1">Next</span> <i class="icon-base ri ri-arrow-right-line icon-16px"></i></button>
          </div>
        </div>
      </div>
      ...
      <div id="property-details" class="content">
        <div class="row g-6">
          ...
          <div class="col-12 d-flex justify-content-between">
            <button class="btn btn-outline-secondary btn-prev"><i class="icon-base ri ri-arrow-left-line icon-16px me-sm-1 me-0"></i> <span class="align-middle d-sm-inline-block d-none">Previous</span></button>
            <button class="btn btn-primary btn-next"><span class="align-middle d-sm-inline-block d-none me-sm-1">Next</span> <i class="icon-base ri ri-arrow-right-line icon-16px"></i></button>
          </div>
        </div>
      </div>
        ...
        <div class="row g-6">
          <div class="col-sm-6">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text" id="pl-expeacted-price"><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text" id="pl-price-sqft"><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text" id="pl-mentenence-charge"><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-floating form-floating-outline">
          ...
          <div class="col-sm-6">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text" id="pl-booking-amount"><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text" id="pl-other-amount"><i class="icon-base ri ri-money-dollar-circle-line icon-20px ms-2"></i></span>
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12 d-flex justify-content-between">
            <button class="btn btn-outline-secondary btn-prev"><i class="icon-base ri ri-arrow-left-line icon-16px me-sm-1 me-0"></i> <span class="align-middle d-sm-inline-block d-none">Previous</span></button>
            <button class="btn btn-success btn-submit btn-next"><span class="align-middle d-sm-inline-block d-none">Submit</span> <i class="icon-base ri ri-check-line icon-16px ms-0 ms-sm-2"></i></button>
          </div>
        </div>
      </div>
    </form>
