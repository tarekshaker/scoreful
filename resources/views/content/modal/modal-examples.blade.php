...
<div class="row g-6">
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="icon-base ri ri-money-dollar-circle-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="icon-base ri ri-bank-card-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="icon-base ri ri-home-3-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="icon-base ri ri-gift-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="icon-base ri ri-user-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="icon-base ri ri-smartphone-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="icon-base ri ri-file-pdf-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="icon-base ri ri-box-3-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="icon-base ri ri-lock-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 icon-base ri ri-bank-card-line icon-28px text-heading"></i>
  ...
  <div class="col-12 col-sm-6 col-lg-4">
    <div class="card">
      <div class="card-body text-center">
        <i class="mb-4 icon-base ri ri-bank-card-2-line icon-28px text-heading"></i>
