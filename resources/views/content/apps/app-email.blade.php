        ...
        <div class="card-body emails-list-header p-3 py-2">
          ...
          <div class="d-flex justify-content-between align-items-center px-3 mt-2">
            <div class="d-flex align-items-center w-100">
              <i class="icon-base ri ri-menu-line icon-lg cursor-pointer d-block d-lg-none me-4 mb-4"
          ...
          <div class="d-flex justify-content-between align-items-center ps-1">
            <div class="d-flex align-items-center">
              ...
              <div class="btn btn-icon btn-text-secondary rounded-pill me-1"><i
                  class="icon-base ri ri-delete-bin-7-line icon-22px email-list-delete cursor-pointer"></i></div>
              <div class="btn btn-icon btn-text-secondary rounded-pill me-1"><i
                  class="icon-base ri ri-mail-open-line icon-22px email-list-read cursor-pointer"></i></div>
          ...
          <ul class="list-unstyled m-0">
            <li class="email-list-item email-marked-read d-flex align-items-center" data-starred="true"
              ...
              <div class="d-flex align-items-center w-100">
                ...
                <span class="ms-sm-2 me-3 d-sm-inline-block d-none"><i
                    class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                ...
                <div class="email-list-item-meta ms-auto d-flex align-items-center">
                  ...
                  <ul class="list-inline email-list-item-actions">
                    ...
                    <li class="list-inline-item email-read btn btn-icon btn-text-secondary rounded-pill"><i
                        class="icon-base ri ri-mail-open-line icon-22px"></i></li>
                    <li class="list-inline-item btn btn-icon btn-text-secondary rounded-pill"><i
                        class="icon-base ri ri-information-line icon-22px"></i></li>
                  </ul>
                </div>
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center">
            <span class="btn btn-icon btn-text-secondary rounded-pill me-1"><i
                class="icon-base ri ri-delete-bin-7-line icon-22px cursor-pointer"></i></span>
            <span class="btn btn-icon btn-text-secondary rounded-pill me-1"><i
                class="icon-base ri ri-mail-line icon-22px cursor-pointer" data-bs-toggle="sidebar"
          ...
          <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
            ...
            <div class="d-flex align-items-center">
              ...
              <span class="btn btn-icon btn-text-secondary rounded-pill"><i
                  class="icon-base ri ri-attachment-2 icon-22px cursor-pointer"></i></span>
              <span class="btn btn-icon btn-text-secondary rounded-pill"><i
                  class="icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
              <div class="dropdown">
        ...
        <div class="modal-header py-3 justify-content-between">
          ...
          <div class="d-flex align-items-center gap-2">
            <button type="button" class="btn btn-icon btn-text-secondary rounded-pill"><i
                class="icon-base ri ri-subtract-line icon-20px"></i></button>
            <button type="button" class="btn btn-icon btn-text-secondary rounded-pill" data-bs-dismiss="modal"
              aria-label="Close"><i class="icon-base ri ri-close-line icon-20px"></i></button>
          </div>
        </div>
            ...
            <div class="email-compose-actions d-flex justify-content-between align-items-center my-4">
              <div class="d-flex align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-primary dropdown-toggle email-send-btn" data-bs-toggle="dropdown"
                    aria-expanded="false">Send <i
                      class="icon-base ri ri-send-plane-line icon-sm scaleX-n1-rtl ms-2"></i></button>
                ...
                <label for="attach-file" class="btn btn-icon btn-text-secondary rounded-pill ms-4"><i
                    class="icon-base ri ri-attachment-2 cursor-pointer icon-20px"></i></label>
                <input type="file" name="file-input" class="d-none" id="attach-file" />
              </div>
              <div class="d-flex align-items-center gap-4">
                <div class="dropdown">
                  <button class="btn btn-sm btn-icon btn-text-secondary p-0" type="button" id="dropdownMoreActions"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <button type="reset" class="btn btn-icon btn-text-secondary rounded-pill" data-bs-dismiss="modal"
                  aria-label="Close"><i class="icon-base ri ri-delete-bin-7-line icon-20px"></i></button>
              </div>
            </div>
          </form>
        </div>
