  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('app/user/view/account') }}"><i class="icon-base ri ri-group-line icon-sm me-1_5"></i>Account</a>
        </li>
        <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-xl-6 order-0 order-xl-0">
            <div class="alert alert-warning mb-4 alert-dismissible" role="alert">
              ...
              <span class="ms-11 ps-sm-1">Your plan requires update</span>
            ...
            <div class="plan-statistics">
              ...
              <div class="progress mb-1 bg-label-primary rounded" style="height: 10px;">
    ...
    <div class="card card-action mb-6">
      <div class="card-header align-items-center flex-wrap gap-2">
        ...
        <div class="card-action-element">
          <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addNewCCModal"><i class="icon-base ri ri-add-line icon-14px me-1"></i>Add Card</button>
        </div>
      </div>
      <div class="card-body">
    ...
    <div class="card card-action mb-4">
      <div class="card-header align-items-center flex-wrap gap-2">
        ...
        <div class="card-action-element">
          <button class="btn btn-sm btn-primary edit-address" type="button" data-bs-toggle="modal" data-bs-target="#addNewAddress"><i class="icon-base ri ri-add-line icon-14px me-1"></i>Edit address</button>
        </div>
      </div>
      <div class="card-body">
        <div class="row">
