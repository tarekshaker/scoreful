    ...
    <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-6">
      ...
      <div class="app-academy-md-50 card-body d-flex align-items-md-center flex-column text-md-center mb-6 py-6">
        ...
        <div class="d-flex align-items-center justify-content-between app-academy-md-80">
          ...
          <button type="submit" class="btn btn-primary btn-icon"><i class="icon-base ri ri-search-line icon-22px"></i></button>
        </div>
      </div>
            ...
            <div class="card-body p-4 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <p class="d-flex align-items-center justify-content-center fw-medium gap-1 mb-0">
                  4.4 <span class="text-warning"><i class="icon-base ri ri-star-s-fill icon-24px me-1"></i></span><span class="fw-normal">(1.23k)</span>
                </p>
              </div>
              ...
              <p class="d-flex align-items-center mb-1"><i class="icon-base ri ri-time-line icon-20px me-1"></i>30 minutes</p>
              ...
              <div class="d-flex flex-column flex-md-row gap-4 text-nowrap flex-wrap flex-md-nowrap  flex-lg-wrap flex-xxl-nowrap">
                <a class="w-100 btn btn-outline-secondary d-flex align-items-center" href="{{ url('app/academy/course-details') }}"> <i class="icon-base ri ri-refresh-line icon-16px align-middle me-1_5"></i><span>Start Over</span> </a>
                <a class="w-100 btn btn-outline-primary d-flex align-items-center" href="{{ url('app/academy/course-details') }}"> <span class="me-1_5">Continue</span><i class="icon-base ri ri-arrow-right-line icon-16px lh-1 scaleX-n1-rtl"></i> </a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card shadow-none border p-2 h-100">
            ...
            <div class="card-body p-4 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-4 pe-xl-4 pe-xxl-0">
                ...
                <p class="d-flex align-items-center justify-content-center fw-medium gap-1 mb-0">
                  4.2 <span class="text-warning"><i class="icon-base ri ri-star-s-fill icon-24px me-1"></i></span><span class="fw-normal"> (424)</span>
                </p>
              </div>
              ...
              <p class="d-flex align-items-center mb-1"><i class="icon-base ri ri-time-line icon-20px me-1"></i>16 hours</p>
              <div class="progress bg-label-primary rounded-pill  mb-4" style="height: 8px">
          ...
          <div class="card shadow-none border p-2 h-100">
            ...
            <div class="card-body p-4 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <p class="d-flex align-items-center justify-content-center fw-medium gap-1 mb-0">
                  5 <span class="text-warning"><i class="icon-base ri ri-star-s-fill icon-24px me-1"></i></span><span class="fw-normal"> (12)</span>
                </p>
              </div>
              ...
              <p class="d-flex align-items-center mb-1"><i class="icon-base ri ri-time-line icon-20px me-1"></i>7 hours</p>
              <div class="progress bg-label-primary rounded-pill  mb-4" style="height: 8px">
            ...
            <div class="card-body p-4 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                  3.8 <span class="text-warning"><i class="icon-base ri ri-star-s-fill icon-24px me-1"></i></span><span class="fw-normal"> (634)</span>
                </p>
              </div>
          ...
          <div class="card shadow-none border p-2 h-100">
            ...
            <div class="card-body p-4 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                  4.7 <span class="text-warning"><i class="icon-base ri ri-star-s-fill icon-24px me-1"></i></span><span class="fw-normal"> (34)</span>
                </p>
              </div>
              ...
              <p class="d-flex align-items-center text-success mb-1"><i class="icon-base ri ri-check-line icon-20px me-1"></i>Completed</p>
              <div class="progress bg-label-primary rounded-pill  mb-4" style="height: 8px">
                <div class="progress-bar w-100" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <a class="w-100 btn btn-outline-primary" href="{{ url('app/academy/course-details') }}"><i class="icon-base ri ri-refresh-line icon-16px me-1_5"></i>Start Over</a>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
          <div class="card shadow-none border p-2 h-100">
            ...
            <div class="card-body p-4 pt-2">
              <div class="d-flex justify-content-between align-items-center mb-4">
                <span class="badge rounded-pill bg-label-danger">UI/UX</span>
                <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                  3.6 <span class="text-warning"><i class="icon-base ri ri-star-s-fill icon-24px me-1"></i></span><span class="fw-normal"> (2.5k)</span>
                </p>
              </div>
        ...
        <div class="card-body d-flex justify-content-between flex-wrap-reverse">
          <div class="mb-0 w-100 app-academy-sm-60 d-flex flex-column justify-content-between text-center text-sm-start">
            <div class="card-title">
              ...
              <p class="text-heading w-sm-80 app-academy-xl-100">Get the right professional certificate program for you.</p>
            </div>
        ...
        <div class="card-body d-flex justify-content-between flex-wrap-reverse">
          <div class="mb-0 w-100 app-academy-sm-60 d-flex flex-column justify-content-between text-center text-sm-start">
            <div class="card-title">
              ...
              <p class="text-heading app-academy-sm-60 app-academy-xl-100">Enroll now in the most popular and best rated courses.</p>
            </div>
      ...
      <div class="col-sm-12 col-lg-4 text-center pt-md-12 px-4">
        <div class="d-flex justify-content-center">
          <div class="avatar avatar-lg mb-4">
            <span class="avatar-initial rounded bg-label-primary"><i class="icon-base ri ri-gift-line icon-36px"></i></span>
          </div>
        </div>
