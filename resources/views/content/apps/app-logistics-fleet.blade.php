...
<div class="card overflow-hidden">
  ...
  <div class="d-flex app-logistics-fleet-wrapper">
    ...
    <div class="flex-shrink-0 position-fixed m-6 d-md-none w-auto z-1">
      <button class="btn btn-white btn-white-dark-variant z-2 p-2" data-bs-toggle="sidebar" data-overlay="" data-target="#app-logistics-fleet-sidebar"><i class="icon-base ri ri-menu-line icon-24px"></i></button>
    </div>
    ...
    <div class="app-logistics-fleet-sidebar col h-100 rounded-0" id="app-logistics-fleet-sidebar">
      <div class="card-header border-0 pt-6 pb-0 d-flex justify-content-between">
        ...
        <i class="icon-base ri ri-close-line icon-24px cursor-pointer close-sidebar d-md-none" data-bs-toggle="sidebar" data-overlay data-target="#app-logistics-fleet-sidebar"></i>
      </div>
                ...
                <div class="d-flex align-items-center">
                  <div class="avatar-wrapper">
                    <div class="avatar me-4">
                      <span class="avatar-initial rounded-circle bg-label-secondary"><i class="icon-base ri ri-car-line icon-24px"></i></span>
                    </div>
                  </div>
                ...
                <ul class="timeline ps-4 mt-8">
                  <li class="timeline-item ps-6 border-dashed">
                    <span class="timeline-indicator-advanced text-success border-0 shadow-none">
                      <i class="icon-base ri ri-checkbox-circle-line icon-sm text-success"></i>
                    </span>
