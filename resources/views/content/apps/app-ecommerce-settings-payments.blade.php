      ...
      <div class="tab-pane fade show active" id="payments" role="tabpanel">
        <div class="card mb-6">
          ...
          <div class="card-body">
            ...
            <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#paymentProvider">Choose a
              provider</button>
          </div>
        </div>
        <div class="card mb-6">
          <div class="card-header">
            <div class="card-title m-0">
              ...
              <p class="card-subtitle mt-0 mb-0">Payment methods that are available with one of Vuexy's approved payment
                providers.</p>
            </div>
          </div>
          <div class="card-body">
            ...
            <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#paymentMethods">Add payment
              methods</button>
          </div>
        </div>
        <div class="card mb-6">
