  ...
  <div class="col-xl-4 col-lg-5 col-md-5 order-1 order-md-0">
          ...
          <div class="d-flex align-items-center gap-4 me-5">
            <div class="avatar">
              <div class="avatar-initial rounded bg-label-primary"><i
                  class="icon-base ri ri-shopping-cart-line icon-24px"></i></div>
            </div>
            <div>
    ...
    <div class="card mb-4 bg-primary">
      <div class="card-body">
        ...
        <button class="btn btn-white text-primary w-100 fw-medium shadow-sm" data-bs-target="#upgradePlanModal"
      ...
      <div class="card-body">
        ...
        <div class="mb-4">
          <div class="d-flex w-100 action-icons">
            <input id="defaultInput" class="form-control form-control-sm me-5" type="text"
              placeholder="+1(968) 945-8832" />
            <a href="javascript:;" class="btn btn-icon btn-outline-secondary me-2" data-bs-target="#enableOTP"
              data-bs-toggle="modal"><i class="icon-base ri ri-edit-box-line ri-22px"></i></a>
            <a href="javascript:;" class="btn btn-icon btn-outline-secondary"><i
                class="icon-base ri ri-user-add-line ri-22px"></i></a>
          </div>
        </div>
        <p class="mb-0">
    ...
    <div class="card mb-6">
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          <tbody>
            <tr>
              <td class="text-truncate"><img src="{{ asset('assets/img/icons/brands/chrome.png') }}" alt="Chrome"
                  class="me-4" width="22" height="22" /><span class="text-heading">Chrome on Windows</span></td>
            ...
            <tr>
              <td class="text-truncate"><img src="{{ asset('assets/img/icons/brands/chrome.png') }}" alt="Chrome"
                  class="me-4" width="22" height="22" /><span class="text-heading">Chrome on iPhone</span></td>
            ...
            <tr>
              <td class="text-truncate"><img src="{{ asset('assets/img/icons/brands/chrome.png') }}" alt="Chrome"
                  class="me-4" width="22" height="22" /><span class="text-heading">Chrome on Android</span></td>
            ...
            <tr>
              <td class="text-truncate"><img src="{{ asset('assets/img/icons/brands/chrome.png') }}" alt="Chrome"
                  class="me-4" width="22" height="22" /><span class="text-heading">Chrome on MacOS</span></td>
