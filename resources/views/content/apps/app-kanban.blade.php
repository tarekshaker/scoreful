      ...
      <div class="tab-content px-0 pb-0 pt-4  ">
        ...
        <div class="tab-pane fade text-heading" id="tab-activity" role="tabpanel">
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">Ray Added mopd <span class="text-heading">Forms & Tables</span> task from in progress to
                done.</p>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">Dianna moved tpk <span class="fw-medium text-heading">FAQ UX</span> from in progress to
                done board.</p>
              <small class="text-body-secondary">Today 7:00 AM</small>
            </div>
          </div>
