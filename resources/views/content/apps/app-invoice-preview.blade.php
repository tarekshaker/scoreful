    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex mb-4">
          <a class="btn btn-outline-secondary d-grid w-100 me-4" target="_blank" href="{{ url('app/invoice/print') }}"> Print </a>
          <a href="{{ url('app/invoice/edit') }}" class="btn btn-outline-secondary d-grid w-100"> Edit </a>
        </div>
