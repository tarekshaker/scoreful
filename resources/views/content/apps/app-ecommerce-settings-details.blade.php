        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            <div class="row mb-6 g-5">
              ...
              <div class="col-12 col-md-6">
                <div class="form-floating form-floating-outline">
                  <input type="tel" class="form-control phone-mask" id="ecommerce-settings-details-phone"
                    placeholder="+(123) 456-7890" name="phone" aria-label="phone" />
            ...
            <div class="alert row alert-warning mb-0 h5 mx-0 " role="alert">
              <span class="col-3 alert-icon me-0 rounded-1 px-0">
        ...
        <div class="card mb-6">
          <div class="card-header">
            <div class="card-title mb-0">
              ...
              <p class="card-subtitle mt-0 mb-0">Shown on the Orders page, customer pages, and customer order
                notifications to identify orders.</p>
            </div>
          </div>
          <div class="card-body">
            <div class="row mb-4 g-5">
              ...
              <div class="col-12 col-md-6">
                <div class="form-floating form-floating-outline">
                  <input type="text" class="form-control" id="ecommerce-settings-sender-suffix" name="suffix"
                    aria-label="Suffix" />
