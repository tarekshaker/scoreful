  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="javascript:void(0);"><i class="icon-base ri ri-lock-2-line icon-sm me-1_5"></i>Security</a>
        </li>
        <li class="nav-item">
      ...
      <div class="card-body pt-0">
        ...
        <div class="mb-4">
          <div class="d-flex w-100 action-icons">
            ...
            <a href="javascript:;" class="btn btn-icon btn-outline-secondary me-2" data-bs-target="#enableOTP" data-bs-toggle="modal"><i class="icon-base ri ri-edit-box-line ri-22px"></i></a>
            <a href="javascript:;" class="btn btn-icon btn-outline-secondary"><i class="icon-base ri ri-user-add-line"></i></a>
          </div>
        </div>
        <p class="mb-0">
