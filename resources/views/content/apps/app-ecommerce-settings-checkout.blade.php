        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            ...
            <div class="alert d-flex align-items-center alert-warning mb-0 h5" role="alert">
              <span class="alert-icon rounded-1"><i class="icon-base ri ri-information-line icon-22px"></i></span>
          ...
          <div class="card-body">
            <div class="mb-4">
              ...
              <div class="form-check ms-4 mb-0">
                ...
                <label class="form-check-label" for="last_and_first_name"> Require first and last name </label>
              </div>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-2">
              ...
              <div class="form-check mb-4 ms-4">
                <input class="form-check-input" type="radio" name="shippingAddress" id="dont_include_ship_address"
                  checked />
                <label class="form-check-label" for="dont_include_ship_address"> Don't include name </label>
              </div>
              <div class="form-check mb-4 ms-4">
