      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between text-center gap-6">
          <div class="d-flex flex-column align-items-center">
            <span class="p-4 border-1 border-primary rounded-circle border-dashed mb-0 w-px-75 h-px-75 text-primary">
            ...
            <div class="d-flex gap-4 align-items-end">
              ...
              <div class="d-flex">
                <button type="button" class="btn btn-facebook btn-icon me-2"><i
                    class="icon-base ri ri-facebook-circle-line text-white"></i></button>
                <button type="button" class="btn btn-twitter btn-icon"><i
                    class="icon-base ri ri-twitter-line text-white"></i></button>
              </div>
            </div>
          </div>
        </form>
