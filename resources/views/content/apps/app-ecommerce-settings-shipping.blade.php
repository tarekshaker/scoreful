      ...
      <ul class="nav nav-align-left nav-pills flex-column">
        <li class="nav-item mb-1">
          <a class="nav-link" href="{{ url('/app/ecommerce/settings/details') }}">
            <i class="icon-base ri ri-store-line icon-sm me-1_5"></i>
        ...
        <div class="card mb-6">
          <div class="card-header d-flex justify-content-between align-items-center gap-4 gap-sm-0">
            <div class="card-title m-0">
              ...
              <p class="card-subtitle mt-0 mb-0">Choose where you ship and how much you charge for shipping at check
                out.</p>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <div>
                <a href="javascript:void(0);" class="text-secondary"><i
                    class="icon-base ri ri-pencil-line icon-22px me-2"></i></a>
                <a href="javascript:void(0);" class="text-secondary"><i
                    class="icon-base ri ri-delete-bin-7-line icon-22px me-2"></i></a>
              </div>
            </div>

            <div class="mb-4">
              <div class="table-responsive text-nowrap border border-bottom-0 rounded">
                <table class="table">
                  <thead>
                    <tr>
                      <th>Rate Name</th>
                      ...
                      <td class="text-end">
                        <div class="dropdown pe-4">
                          <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i
                              class="icon-base ri ri-more-2-line"></i></button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);"><i
                                class="icon-base ri ri-pencil-line me-1"></i> Edit</a>
                            <a class="dropdown-item" href="javascript:void(0);"><i
                                class="icon-base ri ri-delete-bin-7-line me-1"></i> Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="text-end">
                        <div class="dropdown pe-4">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);"><i
                                class="icon-base ri ri-pencil-line me-2"></i> Edit</a>
                            <a class="dropdown-item" href="javascript:void(0);"><i
                                class="icon-base ri ri-delete-bin-7-line me-2"></i> Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="text-end">
                        <div class="dropdown pe-3">
                          <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i
                              class="icon-base ri ri-more-2-line icon-22px"></i></button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);"><i
                                class="icon-base ri ri-pencil-line me-2"></i> Edit</a>
                            <a class="dropdown-item" href="javascript:void(0);"><i
