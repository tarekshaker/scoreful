    ...
    <div class="container py-12">
      ...
      <div class="d-flex align-items-center justify-content-center flex-wrap gap-2 pt-5 mb-6">
        <label class="switch switch-sm ms-sm-5 ps-sm-5 me-0">
          ...
          <span class="switch-label fw-medium fs-6 text-body">Annual</span>
        </label>
          ...
          <div class="card border-primary border shadow-none">
            <div class="card-body position-relative pt-4">
              ...
              <div class="text-center">
                ...
                <small class="price-yearly price-yearly-toggle text-body-secondary">$ 480 / year</small>
              </div>
          ...
          <div class="card border rounded shadow-none">
            <div class="card-body pt-12">
              ...
              <div class="text-center">
                ...
                <small class="price-yearly price-yearly-toggle text-body-secondary">$ 960 / year</small>
              </div>
