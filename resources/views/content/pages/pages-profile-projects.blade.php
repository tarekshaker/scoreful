  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('pages/profile-user') }}"><i class="icon-base ri ri-user-3-line icon-sm me-1_5"></i> Profile</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ url('pages/profile-teams') }}"><i class="icon-base ri ri-team-line icon-sm me-1_5"></i> Teams</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="javascript:void(0);"><i class="icon-base ri ri-computer-line icon-sm me-1_5"></i> Projects</a>
        </li>
        <li class="nav-item">
  ...
  <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="card h-100">
      ...
      <div class="card-body border-top">
        ...
        <div class="progress mb-4 rounded bg-label-primary" style="height: 8px;">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base ri ri-wechat-line icon-24px me-1"></i>15</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base ri ri-wechat-line icon-24px me-2"></i> 236</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base ri ri-wechat-line icon-24px me-1"></i> 98</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base ri ri-wechat-line icon-24px me-1"></i> 120</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base ri ri-wechat-line icon-24px me-1"></i> 20</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-body-secondary d-flex align-items-center"><i class="icon-base ri ri-wechat-line icon-24px me-1"></i> 16</a>
          </div>
        </div>
      </div>
    </div>
