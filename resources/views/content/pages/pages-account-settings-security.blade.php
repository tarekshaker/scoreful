  ...
  <div class="col-md-12">
    <div class="nav-align-top">
      <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="javascript:void(0);"><i class="icon-base ri ri-lock-line icon-sm me-1_5"></i> Security</a>
        </li>
        <li class="nav-item">
          ...
          <div class="col-md-12">
            <div class="bg-lightest rounded p-4 mb-6">
              ...
              <div class="d-flex align-items-center mb-2">
                ...
                <span class="cursor-pointer"><i class="icon-base ri ri-file-copy-line icon-20px"></i></span>
              </div>
    ...
    <div class="card mb-6">
      ...
      <div class="table-responsive">
        <table class="table table-border-bottom-0">
          ...
          <tbody>
            <tr>
              <td class="text-truncate text-heading"><i class="icon-base ri ri-macbook-line icon-20px text-warning me-3"></i>Chrome on Windows</td>
              <td class="text-truncate">HP Spectre 360</td>
              <td class="text-truncate">Switzerland</td>
              <td class="text-truncate">10, July 2021 20:07</td>
            </tr>
            <tr>
              <td class="text-truncate text-heading"><i class="icon-base ri ri-android-line icon-20px text-success me-3"></i>Chrome on iPhone</td>
              <td class="text-truncate">iPhone 12x</td>
              <td class="text-truncate">Australia</td>
              <td class="text-truncate">13, July 2021 10:10</td>
            </tr>
            <tr>
              <td class="text-truncate text-heading"><i class="icon-base ri ri-smartphone-line icon-20px text-danger me-3"></i>Chrome on Android</td>
              <td class="text-truncate">Oneplus 9 Pro</td>
              <td class="text-truncate">Dubai</td>
              <td class="text-truncate">14, July 2021 15:15</td>
            </tr>
            <tr>
              <td class="text-truncate text-heading"><i class="icon-base ri ri-mac-line icon-20px text-info me-3"></i>Chrome on MacOS</td>
            ...
            <tr class="border-transparent">
              <td class="text-truncate text-heading"><i class="icon-base ri ri-android-line icon-20px text-success me-3"></i>Chrome on Android</td>
              <td class="text-truncate">Oneplus 9 Pro</td>
              <td class="text-truncate">Dubai</td>
