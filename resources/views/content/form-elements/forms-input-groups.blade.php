    ...
    <div class="card">
      ...
      <div class="card-body demo-vertical-spacing demo-only-element">
        ...
        <div class="input-group input-group-merge">
          ...
          <div class="form-floating form-floating-outline">
            <input type="text" class="form-control" id="basic-addon11" placeholder="John Doe" aria-label="Username"
    ...
    <div class="card mb-6">
      ...
      <div class="card-body demo-vertical-spacing demo-only-element">
        ...
        <div class="input-group input-group-floating">
          <span class="input-group-text">@</span>
          <div class="form-floating">
            <input type="text" class="form-control" id="basic-addon21" placeholder="John Doe" aria-label="Username"
        ...
        <div class="input-group input-group-floating">
          <div class="form-floating">
            <input type="text" class="form-control" id="basic-addon23" placeholder="john.doe"
              aria-label="Recipient's username" aria-describedby="basic-addon23" />
