        ...
        <div class="row mb-4 form-password-toggle">
          ...
          <div class="col-sm-9">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text cursor-pointer" id="alignment-password2"><i class="icon-base ri ri-eye-off-line"></i></span>
            </div>
          </div>
        </div>
        <hr class="my-6 mx-n4" />
    ...
    <div class="card mb-6">
      <div class="nav-align-top">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item">
            <button class="nav-link " data-bs-toggle="tab" data-bs-target="#form-tabs-account" role="tab" aria-selected="false"><span class="icon-base ri ri-account-pin-circle-line d-sm-none"></span><span class="d-none d-sm-block">Account Details</span></button>
          </li>
          <li class="nav-item">
            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#form-tabs-social" role="tab" aria-selected="false"><span class="icon-base ri ri-facebook-fill d-sm-none"></span><span class="d-none d-sm-block">Social Links</span></button>
          </li>
        </ul>
      </div>
