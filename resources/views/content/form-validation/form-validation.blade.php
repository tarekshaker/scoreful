        ...
        <form class="browser-default-validation">
          ...
          <div class="mb-6 form-password-toggle">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text cursor-pointer" id="basic-default-password3"><i class="icon-base ri ri-eye-off-line icon-20px"></i></span>
            </div>
          </div>
          <div class="form-floating form-floating-outline mb-6">
        ...
        <form class="needs-validation" novalidate>
          ...
          <div class="mb-6 form-password-toggle">
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text rounded-end cursor-pointer" id="basic-default-password4"><i class="icon-base ri ri-eye-off-line icon-20px"></i></span>
              <div class="valid-feedback">Looks good!</div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form id="formValidationExamples" class="row g-4">
          ...
          <div class="col-md-6 form-control-validation">
            <div class="form-password-toggle">
              <div class="input-group input-group-merge">
                ...
                <span class="input-group-text cursor-pointer" id="multicol-password2"><i class="icon-base ri ri-eye-off-line icon-20px"></i></span>
              </div>
            </div>
          </div>
          <div class="col-md-6 form-control-validation">
            <div class="form-password-toggle">
              <div class="input-group input-group-merge">
                ...
                <span class="input-group-text cursor-pointer" id="multicol-confirm-password2"><i class="icon-base ri ri-eye-off-line icon-20px"></i></span>
              </div>
            </div>
          </div>
          <!-- Personal Info -->
          ...
          <div class="col-md-6 form-control-validation">
            <div class="form-floating form-floating-outline">
              <select class="selectpicker tech-select w-100" id="formValidationTech" data-style="btn-default" data-tick-icon="icon-base ri ri-check-line icon-sm text-white" name="formValidationTech" multiple>
          ...
          <div class="col-md-6 form-control-validation">
            <div class="form-floating form-floating-outline">
              <select class="selectpicker hobbies-select w-100" id="formValidationHobbies" data-style="btn-default" data-tick-icon="icon-base ri ri-check-line icon-sm text-white" name="formValidationHobbies" multiple>
