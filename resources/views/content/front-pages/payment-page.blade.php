      ...
      <div class="row">
        ...
        <div class="col-lg-5 card-body p-8 pe-7">
          ...
          <div class="bg-lightest p-6 rounded">
            ...
            <div class="d-grid">
              <a data-bs-target="#pricingModal" data-bs-toggle="modal"
                class="btn btn-outline-primary text-primary">Change Plan</a>
            </div>
          </div>
          <div class="mt-5">
            ...
            <p class="mt-8 mb-0">By continuing, you accept to our Terms of Services and Privacy Policy. Please note that
