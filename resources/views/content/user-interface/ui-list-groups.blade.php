            ...
            <div class="demo-inline-spacing mt-4">
              <div class="list-group">
                <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
                  <div class="avatar flex-shrink-0 text-bg-primary d-flex align-items-center justify-content-center rounded me-4">
                    <i class="icon-base ri ri-bootstrap-line icon-lg"></i>
                  </div>
                  <div class="w-100">
                    <h6 class="mb-2">Bootstrap is an open source toolkit</h6>
                    <div class="progress bg-label-primary" style="height: 5px;">
                      <div class="progress-bar text-bg-primary" role="progressbar" style="width: 95%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </a>
                <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
                  <div class="avatar flex-shrink-0 text-bg-success d-flex align-items-center justify-content-center rounded me-4">
                    <i class="icon-base ri ri-vuejs-line icon-lg"></i>
                  </div>
                  <div class="w-100">
                    <h6 class="mb-2">Vue.js is the Progressive JavaScript Framework</h6>
                    <div class="progress bg-label-success" style="height: 5px;">
                      <div class="progress-bar text-bg-success" role="progressbar" style="width: 85%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </a>
                <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
                  <div class="avatar flex-shrink-0 text-bg-danger d-flex align-items-center justify-content-center rounded me-4">
                    <i class="icon-base ri ri-angularjs-line icon-lg"></i>
                  </div>
                  <div class="w-100">
                    <h6 class="mb-2">Angular implements Functional Programming concepts</h6>
                    <div class="progress bg-label-danger" style="height: 5px;">
                      <div class="progress-bar text-bg-danger" role="progressbar" style="width: 55%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </a>
                <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
                  <div class="avatar flex-shrink-0 text-bg-info d-flex align-items-center justify-content-center rounded me-4">
                    <i class="icon-base ri ri-reactjs-line icon-lg"></i>
                  </div>
                  <div class="w-100">
                    <h6 class="mb-2">List group item heading</h6>
                    <div class="progress bg-label-info" style="height: 5px;">
                      <div class="progress-bar text-bg-info" role="progressbar" style="width: 75%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </a>
                <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-4">
                  <div class="avatar flex-shrink-0 text-bg-warning d-flex align-items-center justify-content-center rounded me-4">
                    <i class="icon-base ri ri-javascript-line icon-lg"></i>
                  </div>
                  <div class="w-100">
                    <h6 class="mb-2">JavaScript is the programming language of the Web</h6>
                    <div class="progress bg-label-warning" style="height: 5px;">
                      <div class="progress-bar text-bg-warning" role="progressbar" style="width: 65%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </a>
              </div>
