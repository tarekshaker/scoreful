                ...
                <div class="modal-content text-center">
                  ...
                  <div id="modalCarouselControls" class="carousel slide pb-6 mb-2" data-bs-interval="false">
                        ...
                        <div class="onboarding-media">
                          <div class="mx-2">
                            <img src="{{ asset('assets/img/illustrations/girl-with-laptop-' . $configData['theme'] . '.png') }}"
                              alt="girl-with-laptop-light" width="335"
                              class="img-fluid"
                        ...
                        <div class="onboarding-media">
                          <div class="mx-2">
                            <img src="{{ asset('assets/img/illustrations/boy-with-laptop-' . $configData['theme'] . '.png') }}"
                              alt="boy-with-laptop-light" width="300"
                              class="img-fluid"
                        ...
                        <div class="onboarding-media">
                          <div class="mx-2">
                            <img src="{{ asset('assets/img/illustrations/girl-verify-password-' . $configData['theme'] . '.png') }}"
                              alt="girl-verify-password-light" width="300"
                              class="img-fluid"
                    ...
                    <a class="carousel-control-prev" href="#modalCarouselControls" role="button" data-bs-slide="prev">
                      <i class="icon-base ri ri-arrow-left-double-line scaleX-n1-rtl lh-1 me-1 icon-sm"></i>
                      <span>Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#modalCarouselControls" role="button" data-bs-slide="next">
                      <span>Next</span>
                      <i class="icon-base ri ri-arrow-right-double-line scaleX-n1-rtl lh-1 ms-1 icon-sm"></i>
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="modal-content text-center">
                  ...
                  <div id="modalHorizontalCarouselControls" class="carousel slide pb-6 mb-2" data-bs-interval="false">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="onboarding-horizontal">
                          <div class="onboarding-media">
                            <img src="{{ asset('assets/img/illustrations/boy-with-rocket-' . $configData['theme'] . '.png') }}"
                              alt="boy-with-rocket-light" width="273"
                              class="img-fluid"
                      ...
                      <div class="carousel-item">
                        <div class="onboarding-horizontal">
                          <div class="onboarding-media">
                            <img src="{{ asset('assets/img/illustrations/boy-with-laptop-' . $configData['theme'] . '.png') }}"
                              alt="boy-with-laptop-light" width="273"
                              class="img-fluid"
                              data-app-light-img="illustrations/boy-with-laptop-light.png"
                              data-app-dark-img="illustrations/boy-with-laptop-dark.png" />
                          </div>
                    ...
                    <a class="carousel-control-prev" href="#modalHorizontalCarouselControls" role="button" data-bs-slide="prev">
                      <i class="icon-base ri ri-arrow-left-double-line icon-sm scaleX-n1-rtl lh-1 me-1 icon"></i>
                      <span>Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#modalHorizontalCarouselControls" role="button" data-bs-slide="next">
                      <span>Next</span>
                      <i class="icon-base ri ri-arrow-right-double-line icon-sm scaleX-n1-rtl lh-1 ms-1"></i>
                    </a>
                  </div>
                </div>
              </div>
