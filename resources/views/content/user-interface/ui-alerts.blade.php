      ...
      <div class="card-body">
        <div class="alert alert-success alert-dismissible" role="alert">
          <h4 class="alert-heading d-flex align-items-center">
            <span class="alert-icon rounded"><i class="icon-base ri ri-checkbox-circle-line icon-md"></i></span>Well done :)
          </h4>
          <hr />
        ...
        <div class="alert alert-danger alert-dismissible" role="alert">
          <h4 class="alert-heading d-flex align-items-center">
            <span class="alert-icon rounded"><i class="icon-base ri ri-error-warning-line icon-md"></i></span>Error!!
          </h4>
        ...
        <div class="alert alert-primary alert-dismissible mb-0" role="alert">
          <h4 class="alert-heading d-flex align-items-center">
            <span class="alert-icon rounded"><i class="icon-base ri ri-user-follow-line icon-md"></i></span>For a watch
          </h4>
  ...
  <div class="col-md">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="alert alert-solid-secondary d-flex align-items-center flex-wrap row-gap-2" role="alert">
          <span class="alert-icon rounded">
        ...
        <div class="alert alert-solid-dark d-flex align-items-center flex-wrap row-gap-2 mb-0" role="alert">
          <span class="alert-icon rounded">
