    ...
    <div
      ...
      <div>
        <a href="{{ config('variables.livePreview') }}" target="_blank"
          class="footer-brand fw-bold">{{ config('variables.templateName') }}</a>
        ©
      </div>
    ...
    <div
      ...
      <div class="d-flex flex-column flex-sm-row gap-4">
        ...
        <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger"> <i
            class="icon-base ri ri-logout-box-r-line icon-xs me-1"></i>Logout</a>
      </div>
    </div>
  </footer>
</section>
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3 mb-6 mb-md-0">
          ...
          <ul class="list-unstyled">
            ...
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">Customers</a>
            </li>
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">Hire us</a>
            </li>
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">FAQs</a>
            </li>
          </ul>
        </div>
        <div class="col-12 col-sm-6 col-md-3 mb-6 mb-sm-0">
          ...
          <ul class="list-unstyled">
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">Admin Template</a>
            </li>
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">UI Kit</a>
            </li>
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">Styleguide</a>
            </li>
            <li>
        ...
        <div class="col-12 col-sm-6 col-md-3">
          ...
          <ul class="list-unstyled">
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">Affiliate Program</a>
            </li>
            <li>
            ...
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">Special Offers</a>
            </li>
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">Page Builder</a>
            </li>
            <li>
              <a href="javascript:void(0)" class="footer-link d-block pb-2">Plans & Pricing</a>
            </li>
          </ul>
        </div>
      </div>
